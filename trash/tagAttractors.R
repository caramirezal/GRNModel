...
# patterns and returns a vector with tagged attractors

# find the pattern defined at the begining of the script in the attractors of the model. Return a vector
# of the tagged attractors.
tagAttractors<-function(net,attractors,patternsList){
